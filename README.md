...
Original plugin was built by Gravitate Design. No license was specified, and contact attempts were slow if any, so the need for fixes drove this fork. Credits for the original work goes to them.
This is a fork (to GitHub) in order to fix bugs, enhance compatibility with WordPress 4x and add some funcitonnality. 

Pull requests are welcomed.

*License*

As mentionned earlier, this is based off work that had no license specified. Until I can arrange something with the original authors, commits are welcomed but please avoid re-using code elsewhere.
...
1.1.0
* ? Not documented by original authors

- Fork -

1.1.1
* Fixed "Trying to get property of non-object"
* Added static method to call to prevent some PHP strict warnings (statically calling non-static method); also initialises the class if it isn't already.

## Roadmap

* Restructure to prevent all PHP strict warnings
* Properly use classes/namespaces to reduce clutter, enhance readability